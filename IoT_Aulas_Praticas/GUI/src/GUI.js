...
var _a = require("@aws-sdk/client-dynamodb"), DynamoDBClient = _a.DynamoDBClient, ScanCommand = _a.ScanCommand, QueryCommand = _a.QueryCommand;
// Set the AWS Region
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        function contagem_de_nodos() {
            return __awaiter(this, void 0, void 0, function () {
                ...
                var params_1, results, err_2, index;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            if (!(i <= nr_salas)) return [3 /*break*/, 5];
                            params_1 = {
                        ...
                        case 1:
                            _a.trys.push([1, 3, , 4]);
                            return [4 /*yield*/, dbclient.send(new QueryCommand(params_1))];
                        case 2:
                            results = _a.sent();
        ...
        var nr_salas, params, data_1, err_1, i, id_array, room_array;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    nr_salas = 0;
