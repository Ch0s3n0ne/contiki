                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    ...
                                    case 12:
                                        ...
                                        id_array = id_array.sort(function (a, b) { return a - b; });
                                        changes_array = [];
                                    ...
                                    case 21:
                                        ...
                                        for (index = 0; index < index_array.length; index++) {
                                            ...
                                            if (smoke_show[index] == '1') {
                                                ...
                                                for (index1 = 0; index1 < ids_array.length; index1++) {
                                                ...
                                                date = new Date(array_time_index[tempo_inicio] * 1000);
                                                tempo_fumo = " " + date.getDate() + "/" + (date.getMonth() + 1) + "/" + date.getFullYear() + " " + date.getHours() + ":" + date.getMinutes() + ":" + date.getSeconds();
