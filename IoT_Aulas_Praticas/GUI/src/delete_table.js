...
var _a = require("@aws-sdk/client-dynamodb"), DynamoDBClient = _a.DynamoDBClient, DeleteTableCommand = _a.DeleteTableCommand;
// Set the AWS Region
...
var run = function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, dbclient.send(new DeleteTableCommand(params))];
            case 1:
                data = _a.sent();
